...
> Answer: It is much faster than loading and reloading data when using server side routing.
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer: Controlled components are set in state and updated with setState().
